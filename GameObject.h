...
public:
	...
	//todo a setter:
	void SetPosition(const CellPosition &pos); // A Setter for position
	// ============ Virtual Functions ============
	...
	virtual void Save(ofstream &,int type) = 0;	// Saves the GameObject parameters to the file --> feel free to change this prototype as needed
	virtual void Load(ifstream &,int type) = 0;	// Loads and Reads the GameObject parameters from the file --> feel free to change this prototype as needed
